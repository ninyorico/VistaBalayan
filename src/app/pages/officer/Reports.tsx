...
export default function Reports() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* KPI Cards */}
      <div className="grid grid-cols-6 gap-2 sm:gap-4 lg:gap-6">
        <div className="col-span-2 min-w-0 rounded-lg border border-gray-200 bg-white p-3 shadow-sm sm:p-6">
        ...
        <div className="col-span-3 min-w-0 rounded-lg border border-gray-200 bg-white p-3 shadow-sm sm:p-6">
