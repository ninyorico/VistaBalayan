  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h1 className="vista-title">Submission history</h1>
      </div>
      ...
      <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="flex flex-col gap-3 border-b border-slate-100 bg-slate-50/70 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="inline-flex items-center gap-2 rounded-2xl bg-white px-4 py-2 text-sm font-semibold text-slate-700 ring-1 ring-slate-200">
            <CalendarRange className="h-4 w-4 text-[#0E5A72]" />
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="rounded-full bg-[#0F4C75]/10 px-2.5 py-1 text-xs font-bold text-[#0E5A72]">
                          {week.label}
                        </span>
                  ...
                  <table className="min-w-[720px] w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {getVisitorRecordsForSubmission(viewingSubmission).map((report) => (
                        <tr key={report.id}>
                          <td className="px-3 py-2 font-medium text-slate-900">{report.guest_name || "N/A"}</td>
                          <td className="px-3 py-2 text-slate-700">{report.residence_type || "N/A"}</td>
                          <td className="px-3 py-2 text-slate-700">{report.place_of_residence || "N/A"}</td>
